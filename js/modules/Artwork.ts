...
export default class Artwork {
  ...
  init() {
    ...
    var cube1 = this.createMesh(new THREE.BoxGeometry(10, 10, 10, 1, 1, 1), [0, 0, 0])
    scene.add(cube1)

    var cube2 = this.createMesh(new THREE.BoxGeometry(10, 10, 10, 1, 1, 1), [7, 10, 10])
    scene.add(cube2)
    ...
    const visibilityCounts = this.getCameraView(scene)
  ...
  createMesh(geom: THREE.BoxGeometry, xyz: number[]) {
  ...
  getCameraView(scene: THREE.Scene) {
